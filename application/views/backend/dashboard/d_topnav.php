<?php
$bg = isset($bg) ? $bg : 'primary';
?>
<nav class="navbar navbar-top navbar-expand navbar-dark bg-<?= $bg ?> border-bottom">
                              ...
                              <a class="nav-link pr-0" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <div class="media align-items-center">
                                          <span class="avatar avatar-sm rounded-circle">
                                                <img alt="Image placeholder" src="<?= base_url('assets/backend/img/profile/' . $user['image']) ?>">
                                          </span>
